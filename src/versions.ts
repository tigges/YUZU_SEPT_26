...
export const versions = [
  ...
  },
  {
    ...
    name: 'Round',
    kicker: 'Version 4',
    summary: 'The Clean layout with rounded cards, gallery tiles, and service boxes.',
    preview: asset('assets/gallery/1.jpg'),
    previewAlt: 'Copper and rose colour with textured fringe',
  },
  {
  ...
  },
  {
    ...
    summary:
      'Page order you can drag. Welcome, prices, map, and the rest of the version segments are here. → / ← nest a section as a sub-page. Archive is below the footer.',
    preview: asset('assets/brand/leaves.jpg'),
